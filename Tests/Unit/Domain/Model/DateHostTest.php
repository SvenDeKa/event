...
/**
 * Test case for class \TYPO3\Z3Event\Domain\Model\DateHost.
 *
 * @version $Id$
 ...
 */
class DateHostTest extends \TYPO3\CMS\Extbase\Tests\Unit\BaseTestCase {
	/**
	 * @var \TYPO3\Z3Event\Domain\Model\DateHost
	 */
	protected $fixture;

	public function setUp() {
		$this->fixture = new \TYPO3\Z3Event\Domain\Model\DateHost();
	}
	 ...
	 * @test
	 */
	public function getHostReturnsInitialValueForHost() { }

	/**
	 * @test
	 */
	public function setHostForHostSetsHost() { }
