...
/**
 * Test case for class \TYPO3\Z3Event\Domain\Model\Attendee.
 *
 * @version $Id$
 ...
 */
class AttendeeTest extends \TYPO3\CMS\Extbase\Tests\Unit\BaseTestCase {
	/**
	...
	public function setUp() {
		$this->fixture = new \TYPO3\Z3Event\Domain\Model\Attendee();
	}
	 ...
	 * @test
	 */
	public function getDatesReturnsInitialValueForDateAttendee() { 
	 ...
	 * @test
	 */
	public function setDatesForObjectStorageContainingDateAttendeeSetsDates() { 
		$date = new \TYPO3\Z3Event\Domain\Model\DateAttendee();
