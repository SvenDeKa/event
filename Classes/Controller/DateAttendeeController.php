 ...
 *
 */
class DateAttendeeController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController {
...
//		$propertyMappingDateAttendeeConfiguration = $this->arguments['newDateAttendee']->getPropertyMappingConfiguration();
//		$propertyMappingDateAttendeeConfiguration->allowAllProperties();
//		$propertyMappingDateAttendeeConfiguration->setTypeConverterOption('TYPO3\CMS\Extbase\Property\TypeConverter\PersistentObjectConverter', \TYPO3\CMS\Extbase\Property\TypeConverter\PersistentObjectConverter::CONFIGURATION_CREATION_ALLOWED, TRUE);
	
//		$propertyMappingConfiguration = $this->arguments['newAttendee']->getPropertyMappingConfiguration();
...
//		$propertyMappingConfiguration->setTypeConverterOption('TYPO3\CMS\Extbase\Property\TypeConverter\PersistentObjectConverter', \TYPO3\CMS\Extbase\Property\TypeConverter\PersistentObjectConverter::CONFIGURATION_CREATION_ALLOWED, TRUE);
	 ...
	 * action show
	 *
	 * @param \TYPO3\Z3Event\Domain\Model\DateAttendee $dateAttendee
	 * @return void
	 */
	public function showAction(\TYPO3\Z3Event\Domain\Model\DateAttendee $dateAttendee) {
		$this->view->assign('dateAttendee', $dateAttendee);
...
//		$this->redirect('new');
//		$this->redirect('list', 'Date');
		$this->redirect('show', 'Date', 'Z3Event', array('date' => $this->request->getArgument('date')));
	}
