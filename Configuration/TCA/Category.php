...
$TCA['tx_z3event_domain_model_category'] = array(
	'ctrl' => $TCA['tx_z3event_domain_model_category']['ctrl'],
	'interface' => array(
	...
	'columns' => array(
		...
		'name' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:z3_event/Resources/Private/Language/locallang_db.xlf:tx_z3event_domain_model_category.name',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim,required'
		...
		'parent' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:z3_event/Resources/Private/Language/locallang_db.xlf:tx_z3event_domain_model_category.parent',
			'config' => array (
				'type' => 'group',
				'internal_type' => 'db',
				'foreign_table' => 'tx_z3event_domain_model_category',
				'allowed' => 'tx_z3event_domain_model_category',
				'foreign_field' => 'children',
				'minitems' => 0,
				'maxitems' => 1,
				'wizards' => array(
					'suggest' => array(
